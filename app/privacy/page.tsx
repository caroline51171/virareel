      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <p className="mt-3">Attribution publicitaire (interne) : lorsque vous arrivez via une publicité, nous pouvons enregistrer des paramètres techniques de la campagne (par exemple UTM, identifiant de clic Meta « fbclid », et la page d’atterrissage) et les associer à votre compte, uniquement pour analyser la performance de nos publicités dans notre espace d’administration. Ces données ne servent pas à vous recibler ni à créer des audiences publicitaires. Au Canada, dans l’Espace économique européen, au Royaume-Uni et en Suisse, nous ne les enregistrons qu’après votre acceptation dans la bannière. Hors de ces territoires, notamment aux États-Unis, elles peuvent être enregistrées par défaut ; vous pouvez refuser à tout moment via « Refuser » ou « Gérer les cookies ».</p>
            <p className="mt-3">Conservation : le cookie virareel-origine reste au plus 90 jours dans votre navigateur (y compris avant toute inscription). Si vous créez un compte, les paramètres d’attribution associés à ce compte sont conservés tant que le compte est actif, puis supprimés ou anonymisés à la suppression du compte. Si vous fournissez un courriel (par exemple pour débloquer des essais) sans créer de compte, la provenance peut rester associée à ce courriel jusqu’à ce que vous en demandiez la suppression à <a href="mailto:hello@virareelai.com" className="text-violet-400 hover:text-violet-300">hello@virareelai.com</a>, ou jusqu’à anonymisation. Dans tous les cas, ces données servent uniquement à l’analyse interne de nos publicités, pas au reciblage.</p>
          </section>
