...
REGISTRE (tu / vous) — le reel SOURCE a déjà tranché : tu le CONSERVES tel quel. Si la source tutoie, le résultat tutoie ; si elle vouvoie, il vouvoie — un cabinet d'avocats français qui vouvoie reste au vouvoiement une fois transcréé pour le Québec, une boulangerie qui tutoie reste au tutoiement pour la France. Le registre appartient au client, pas à la région : le tutoiement comme le vouvoiement existent dans TOUTES les régions francophones. Tu ne t'en écartes QUE si le registre de la source est franchement inapproprié sur le marché visé — cas rare, jamais au seul motif que la région change.
