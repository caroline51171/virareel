...
Retourne EXACTEMENT ce JSON (et rien d'autre) :
{
  "instagram": {
    ...
    "caption": "2-3 lignes de valeur après le hook de caption, puis question engageante pour commentaires. Emojis + 1 hashtag large + 2-3 hashtags catégorie + 2-3 hashtags niche = 5-8 hashtags.",
...
Return EXACTLY this JSON (nothing else):
{
  "instagram": {
    ...
    "caption": "2-3 lines of value after the caption hook, then engaging question for comments. Emojis + 1 broad hashtag + 2-3 category hashtags + 2-3 niche hashtags = 5-8 hashtags.",
  ...
  ? `Return EXACTLY this JSON (nothing else):
{
  ...
  "caption": "${platform === 'instagram' ? '2-3 lines of value + engaging question. Emojis + 1 broad hashtag + 2-3 category hashtags + 2-3 niche hashtags = 5-8 hashtags.' : platform === 'tiktok' ? '1-2 sentences with the topic keywords (the same ones spoken in the script — TikTok matches caption and transcript) + 3-5 hashtags (1 category + 2-4 niche). NEVER #fyp or #foryou or billion-post hashtags.' : platform === 'youtube' ? 'only 2-3 relevant hashtags, aligned with the title keyword (the title outweighs tags in 2026).' : '1 broad hashtag + 2-3 category hashtags + 2-3 niche hashtags = 5-8 hashtags.'}",
  "bestTime": "e.g: Tue-Thu, 6pm-9pm",
