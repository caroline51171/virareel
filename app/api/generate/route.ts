  ...
  ? `Retourne EXACTEMENT ce JSON (et rien d'autre) :
{
  ...
  "caption": "${platform === 'instagram' ? '2-3 lignes de valeur + question engageante. Emojis + 1 hashtag large + 2-3 hashtags catégorie + 2-3 hashtags niche = 5-8 hashtags.' : platform === 'tiktok' ? '1-2 phrases avec les mots-clés du sujet (les mêmes que dans le script parlé — TikTok aligne légende et transcription) + 3-5 hashtags (1 de catégorie + 2-4 de niche). JAMAIS #fyp ni #pourtoi ni les hashtags à milliards de posts.' : '1 hashtag large + 2-3 hashtags catégorie + 2-3 hashtags niche = 5-8 hashtags.'}",
  "bestTime": "ex: Mardi-Jeudi, 18h-21h",
  ...
  ? `Return EXACTLY this JSON (nothing else):
{
  ...
  "caption": "${platform === 'instagram' ? '2-3 lines of value + engaging question. Emojis + 1 broad hashtag + 2-3 category hashtags + 2-3 niche hashtags = 5-8 hashtags.' : platform === 'tiktok' ? '1-2 sentences with the topic keywords (the same ones spoken in the script — TikTok matches caption and transcript) + 3-5 hashtags (1 category + 2-4 niche). NEVER #fyp or #foryou or billion-post hashtags.' : '1 broad hashtag + 2-3 category hashtags + 2-3 niche hashtags = 5-8 hashtags.'}",
  "bestTime": "e.g: Tue-Thu, 6pm-9pm",
