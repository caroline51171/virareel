        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li><strong className="text-white">Ad source (virareel-origine):</strong> when you arrive from an ad, keeps the campaign parameters described in section 5 (UTM tags, fbclid, landing page), under the same consent rules. Duration: 90 days. Deleted if you decline.</li>
            </ul>
