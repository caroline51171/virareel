      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <p className="mt-3">Ad attribution (internal): when you arrive from an ad, we may store campaign technical parameters (for example UTM tags, the Meta click ID “fbclid”, and the landing page) and link them to your account, solely to analyse our ad performance in our admin tools. This data is not used to retarget you or to build ad audiences. In Canada, the European Economic Area, the United Kingdom and Switzerland, we only store it after you accept in the cookie banner. Outside those regions, including the United States, it may be stored by default; you can refuse anytime via “Decline” or “Manage cookies”.</p>
            <p className="mt-3">Retention: the virareel-origine cookie stays in your browser for at most 90 days (including before any sign-up). If you create an account, attribution parameters linked to that account are kept while the account is active, then deleted or anonymised when the account is deleted. If you provide an email (for example to unlock extra trials) without creating an account, provenance may stay linked to that email until you ask us to delete it at <a href="mailto:hello@virareelai.com" className="text-violet-400 hover:text-violet-300">hello@virareelai.com</a>, or until we anonymise it. In all cases, this data is used only for our internal ad analysis, not for retargeting.</p>
          </section>
          <section>
